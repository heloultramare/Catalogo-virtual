...
import Logo from "../Pandora-logo.png";
        ...
        <Container maxWidth="xl">
            <Toolbar disableGutters>
              <Grid container sx={{ alignItems: "center" }}>
                ...
                <Grid xs={2} md={2} item sx={{display: {lg: "none" , xs: "block" , md: "block" }}}>
                  <IconButton  
                    size="large"
                ...
                <Grid item lg={8} md={6} sx={{ display: {lg: "block" , xs: "none" , md: "none"} }}>
                  <Box>
                ...
                <Grid item lg={2} xs={4} md={2} sx={{ textAlign: "right" }}>
                  <Tooltip title= "Perfil">
                    <IconButton onClick={handleOpenUserMenu}>
                      <Avatar alt="Heloísa Ultramare" src=""/>
                    </IconButton>
                  </Tooltip>
                  <Menu
                    sx={{ mt: '45px' }}
